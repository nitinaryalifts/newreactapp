    ...
    <div className={`main_Content `}>
      {loading ? (
        ...
        <>
          ...
          <div className={`about_sections animate_section ${animationClass}`}>
            {/* About Me Section */}
            <section className="aboutme_section">
              <Row>
                <Col md={6}>
                  <div
                    className="leftimgbox"
                  ...
                  <div className="rightContetnbox text-start">
                    {theme.subtitles && theme.subtitles.length > 0 && (
                      <div
                        dangerouslySetInnerHTML={{
                          __html: theme.subtitles[0].subtitle,
                        }}
                      />
                    )}
                    <h2
                      className="hp-main-title"
                    ...
                    <div className="hp-buttons mt-4">
                      {theme.buttons && theme.buttons.length > 0 && (
                        <>
                          <a
                            href={theme.buttons[0].url}
                            target="yes"
                            className="custom_btn custom-primary me-2"
                            dangerouslySetInnerHTML={{
                              __html: theme.buttons[0].button_title,
                            }}
                          ></a>
                          <a
                            href={theme.buttons[1].url}
                            target=""
                            ...
                            dangerouslySetInnerHTML={{
                              __html: theme.buttons[1].button_title,
                            }}
                          ></a>
                        </>
                      )}
                  ...
                  <Col md={6} key={index}>
                    <div className="info_box d-flex gap-4 py-3 pe-3">
                      ...
                      <div className="infoContent">
                        <h4
                          className="mt-1 heading_bl"
                          dangerouslySetInnerHTML={{
                            __html: item.settings.title,
                          }}
                        ></h4>
                        <p
                          className="about_parah"
                          dangerouslySetInnerHTML={{
                            __html: item.settings.description,
                          }}
                        ></p>
                      </div>
                    </div>
                  ...
                  {testimonials.map((item, key) => (
                    <div className="Slider_Item d-flex flex-column" key={key}>
                      ...
                      <div className="testimonial_credits">
                        ...
                        <a href={item.link} className="desg">
                          {item.company}
                        </a>
                        <img
                          className="sliderAvtar_"
                          src={item.image.url}
                          height="auto"
                          width="auto"
                          alt="testimonial"
